...
const indexByNameSpec = Object.freeze({
  labels: {
    element: '_',
    descendants: '_children',
    text: '_text'
...
const groupByNameSpec = Object.freeze({
  labels: {
    element: '_',
    descendants: '_children',
    text: '_text'
...
const indexByNameAttrsArray = Object.freeze({
  labels: {
...
const indexByGroupAttrsArray = Object.freeze({
  labels: {
    attributes: '_attributes',
    element: '_',
    descendants: '_children',
...
const Specs = {
  default: defaultSpec,
  indexByName: indexByNameSpec,
  groupByName: groupByNameSpec,
  indexByNameAttrsArray: indexByNameAttrsArray,
  groupByNameAttrsArray: indexByGroupAttrsArray
};
...
const buildElementWithSpec = R.curry((elementNode, parentNode, spec, getOptions) => {
  ...
  return Impl.buildElement(elementNode, parentNode, spec, getOptions);
});
