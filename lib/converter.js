 ...
 *    options (
 * @property:"id": the attribute that identifies an element, which usually should be unique,
 * @property:"recurse" the attribute used for element inheritance,
 * @property: "discards" the list of attributes that can be discarded and not appear in the JSON,
 * @property descendants(optional): Sub - object:
