        ...
        if (R.includes(R.toLower(collectionType), ['map', 'weakmap', 'object', '{}'])) {
          ...
          arrayElements = R.reduce((acc, collectionPair) => {
            ...
            if (elements.length === 2) {
              const coercedKeyResult = transformAssocValue(assocValueType, context, spec, elements[0]);
              const coercedValueResult = transformAssocValue(assocValueType, context, spec, elements[1]);
